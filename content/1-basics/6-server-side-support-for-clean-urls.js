...
You just don't need to use [Express](https://expressjs.com/). You can use any Node.js server framework for that. You can also look at the Next.js documentation for the [custom server API](https://github.com/zeit/next.js#custom-server-and-routing).
      `
    }
  ]
}